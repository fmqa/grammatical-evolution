...
Unlike traditional/classic GE which uses BNF, this module uses grammars specified using Python generators (See the `arithmetic` grammar in `picoga/grammatical.py` for an example).
